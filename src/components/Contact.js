...
const Contact = props => {
	return <div className='component-parent padder' id='contact'>
		<div className='component-wrapper contact-parent'>
			<span className={`large-text white uppercase letter-spacer header boldish  ${props.isViz ? 'animate__animated animate__fadeInDown  showElem' : 'hideElem'}`}>Contact</span>
