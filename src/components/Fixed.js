			...
			<div className={`fixed-parent max-width padder ${this.props.isNavVisible ? 'nav-active' : '' }`}>
				<div className='fixed-child'>
					<div className={`fixed-text ${this.props.isNavVisible ? 'nav-active' : '' }`}>
						<span className='large-text letter-spacer-small white'>Abhi Gupta</span>
						<span className='h2 grey light fixed-small'>Undergraduate Student. Software Engineer. <span className='emphasis-color'>Aspiring Scientist.</span></span>
					</div>		
