...
export default {
	...
	sections: [
		// content must be an array
		{
			title:'News',
			content:[
				'I will be the CA of the graduate class taught by Shipra Agrawal, Reinforcement Learning: Theory & Practice.', 
				'I interned at Ctrl-Labs, acquired by Facebook Reality Labs, as part of the science and interactions team.', 
